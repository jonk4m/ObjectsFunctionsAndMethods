...
def try_methods():
    ...
    caitlin.pen = rg.Pen('brown', 5)
    caitlin.pen_down()
    caitlin.forward(150)
    caitlin.left(90)
    caitlin.forward(50)
    caitlin.backward(100)
    caitlin.pen_up()
...
def try_methods_and_functions():
    ...
    """
    caitlin5 = rg.SimpleTurtle()
    caitlin5.pen = rg.Pen('blue', 5)
    caitlin5.backward(150)
    caitlin5.speed = 1
    draw_many_squares(caitlin5, 2, 100, 30)
    caitlin5.speed = 5
    caitlin5.pen = rg.Pen('red', 5)
    draw_many_squares(caitlin5, 10, 50, 15)
    caitlin5.speed = 100
    caitlin5.pen = rg.Pen('red', 35)
    draw_many_squares(caitlin5, 8, 300, 60)
    caitlin5.pen = rg.Pen('black', 3)
    caitlin5.backward(200)
    caitlin5.pen_down()
    caitlin5.draw_circle(30)
    caitlin5.draw_square(50)
    ####################################################################
